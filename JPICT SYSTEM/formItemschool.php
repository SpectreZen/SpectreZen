<!-- https://www.jotform.com/form-templates/request-form/it-request-forms -->
	...
	<div class="row d-flex justify-content-center align-items-center center">
		<div class="col-md-6" style="padding: 20px;">
			<div class="card">
				...
				<div class="card-body">
					<form action="insertItemSchool.php" method="post" name="ICTForm">
						<div class="form-row">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
							<label for="statusBarang">Status Perkakasan</label> 
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								<label for="kosUnit">Surat Rujukan</label> <input type="text" class="form-control" id="suratRujukan" name="suratRujukan"
								value="<?php echo $_GET['suratRujukan']?>" readonly>
							</div>
						</div>
